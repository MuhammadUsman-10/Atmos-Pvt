            ...
            <div className="container mx-auto px-6">
                <div className='flex flex-col md:flex-row justify-between'>
                    ...
                    <div className='w-1/2'>
                        ...
                        <div className='flex flex-row justify-between gap-4 relative items-center'>
                            ...
                            <span className="absolute left-1/2 transform -translate-x-1/2 -translate-y-[0%] w-[1px] h-22 mt-4 bg-white"></span>
