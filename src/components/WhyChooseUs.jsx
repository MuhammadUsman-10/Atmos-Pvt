        ...
        <div className="relative">
          <div className="overflow-hidden">
            <div className="flex animate-scroll gap-8">
              {/* First set of cards */}
              <div className="group relative flex flex-col items-left gap-4 text-left p-6 lg:p-10 bg-[#1f1f1f] rounded-lg shadow-lg w-[220px] xsm:w-[250px] lg:w-[300px] flex-shrink-0 overflow-hidden">
