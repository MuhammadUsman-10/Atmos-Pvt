        ...
        <div className="relative">
          <div className="overflow-hidden">
            <div className="flex animate-scroll gap-8">
              {/* First set of cards */}
              <div className="group relative flex flex-col items-left gap-8 text-left p-6 lg:p-10 bg-[#1f1f1f] rounded-lg shadow-lg w-[220px] xsm:w-[250px] lg:w-[300px] flex-shrink-0 overflow-hidden">
                <div className="absolute inset-0 bg-[#ffaa17] transform origin-bottom scale-y-0 group-hover:scale-y-100 transition-transform duration-300 ease-in-out"></div>
                <div className="relative z-10">
                  <svg fill="currentColor" className="h-16 w-16 group-hover:text-black text-[#ffaa17] mb-6"  version="1.0" xmlns="http://www.w3.org/2000/svg"
                      ...
                      -45 0 -45 87 -19 86 -19 50 -120 49 -120 48 77 47 77 -30 31 -31 30 -77 -47 -77 -48
