            ...
            >
                <form ref={form} onSubmit={sendEmail} className="space-y-5">
                    ...
                    <button
                        type="submit"
                        disabled={isSending}
                        className="btn-slide-bg w-full justify-center py-3 px-4 border-[0.5px] border-transparent hover:border-[#ffaa17] cursor-pointer text-black hover:text-[#ffaa17] shadow-sm text-sm uppercase font-medium rounded-sm bg-[#ffaa17] transition-colors delay-100 relative"
                    >
                        <span className='relative'>{isSending ? 'Sending...' : 'Send'}</span>
                    </button>
